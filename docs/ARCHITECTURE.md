...
11. Nouveau test en jeu à faire avec `dist/beamai.zip` reconstruit (voir `README.md`, Test 3 pour les corrections précédentes, Test 4 pour l'esquive). Une fois ces deux validés, poursuivre la phase 3 (fusion, clignotants, dépassement d'un véhicule en mouvement) puis attaquer la phase 2 (intersections).
